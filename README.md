...
> Issue Found in Lit Action Code:  
An issue has been identified in the Lit Action code. Currently, the code signs 'toSign' generated by the client, but it should be signing 'toSign' generated within Lit Action.
